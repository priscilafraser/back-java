...
create table ligacao_fornecedor_produto (id bigint generated by default as identity, created_at TIMESTAMP WITHOUT TIME ZONE, descricao varchar(255), imagem varchar(255), preco float not null, update_at TIMESTAMP WITHOUT TIME ZONE, idfornecedor bigint, idproduto bigint, primary key (id));
create table ligacao_fornecedor_servico (id bigint generated by default as identity, created_at TIMESTAMP WITHOUT TIME ZONE, descricao varchar(255), preco float not null, update_at TIMESTAMP WITHOUT TIME ZONE, idfornecedor bigint, idservico bigint, primary key (id));
...
alter table ligacao_fornecedor_produto add constraint FKn19r6nsinw4o40uod71de4hqj foreign key (idproduto) references produto;
...
alter table ligacao_fornecedor_servico add constraint FKh30anm5dhtsx1clc1410y8ene foreign key (idservico) references servico;
